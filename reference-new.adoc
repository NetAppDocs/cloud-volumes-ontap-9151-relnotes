...
The 9.15.1 P14 patch is now available for Cloud Volumes ONTAP for all cloud providers. The NetApp Console will prompt you to upgrade your existing systems to this patch release.
...
The 9.15.1 P13 patch is now available for Cloud Volumes ONTAP for all cloud providers. The NetApp Console will prompt you to upgrade your existing systems to this patch release.
