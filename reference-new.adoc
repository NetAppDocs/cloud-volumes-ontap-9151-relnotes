...
The 9.15.1 P16 patch is now available for Cloud Volumes ONTAP for all cloud providers. The Console will prompt you to upgrade your existing systems to this patch release.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P16[View the list of bugs fixed in the P16 patch^] (NetApp Support Site login required).
